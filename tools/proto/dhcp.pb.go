...
var file_proto_dhcp_proto_goTypes = []any{
	(*NetworkInterface)(nil),             // 0: managers.NetworkInterface
	(*RequestConfigureDHCP)(nil),         // 1: managers.RequestConfigureDHCP
	(*Lease)(nil),                        // 2: managers.Lease
	(*ResponseGetNetworkInterfaces)(nil), // 3: managers.ResponseGetNetworkInterfaces
	(*ResponseGetLeases)(nil),            // 4: managers.ResponseGetLeases
	(*timestamppb.Timestamp)(nil),        // 5: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),                // 6: google.protobuf.Empty
	(*Response)(nil),                     // 7: generic.Response
}
var file_proto_dhcp_proto_depIdxs = []int32{
	5, // 0: managers.Lease.expire:type_name -> google.protobuf.Timestamp
	0, // 1: managers.ResponseGetNetworkInterfaces.data:type_name -> managers.NetworkInterface
	2, // 2: managers.ResponseGetLeases.data:type_name -> managers.Lease
	6, // 3: managers.DHCPService.GetNetworksInterfaces:input_type -> google.protobuf.Empty
	1, // 4: managers.DHCPService.ConfigureDHCP:input_type -> managers.RequestConfigureDHCP
	6, // 5: managers.DHCPService.Start:input_type -> google.protobuf.Empty
	6, // 6: managers.DHCPService.Stop:input_type -> google.protobuf.Empty
	6, // 7: managers.DHCPService.Reload:input_type -> google.protobuf.Empty
	6, // 8: managers.DHCPService.GetLeases:input_type -> google.protobuf.Empty
	3, // 9: managers.DHCPService.GetNetworksInterfaces:output_type -> managers.ResponseGetNetworkInterfaces
	7, // 10: managers.DHCPService.ConfigureDHCP:output_type -> generic.Response
	7, // 11: managers.DHCPService.Start:output_type -> generic.Response
	7, // 12: managers.DHCPService.Stop:output_type -> generic.Response
	7, // 13: managers.DHCPService.Reload:output_type -> generic.Response
	4, // 14: managers.DHCPService.GetLeases:output_type -> managers.ResponseGetLeases
