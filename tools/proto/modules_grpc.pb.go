...
const (
	ModuleService_GetModules_FullMethodName = "/module.ModuleService/GetModules"
)
...
func (c *moduleServiceClient) GetModules(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetModulesResponse, error) {
...
func (UnimplementedModuleServiceServer) GetModules(context.Context, *emptypb.Empty) (*GetModulesResponse, error) {
...
func _ModuleService_GetModules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ModuleServiceServer).GetModules(ctx, req.(*emptypb.Empty))
	}
