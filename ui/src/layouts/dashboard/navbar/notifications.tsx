            ...
            <ClickOutside onClick={() => handleDropdown(false)} className="relative">
                <li>
                    <Link to="#"
                          ...
                          className="relative flex h-9 w-9 items-center justify-center rounded-full border-[0.5px] stroke-1 hover:text-primary bg-gray-100">
                        <span
                            className={`absolute -top-0.5 right-0 z-10 h-2 w-2 rounded-full bg-red-500 ${!notifying ? 'hidden' : 'inline'}`}>
                            <span
                                className="absolute -z-10 inline-flex h-full w-full animate-ping rounded-full bg-red-500 opacity-75"></span>
                        </span>
                        ...
                        <svg fill="none" height="24" viewBox="0 0 24 24" width="24">
                            <g fill="rgb(0,0,0)">
                                ...
                                <path
                                    d="m15.7023 19.2632c.1454-.3879-.0512-.8201-.4391-.9655s-.8201.0512-.9655.4391zm-6-.5264c-.14536-.3879-.57763-.5845-.9655-.4391s-.58446.5776-.4391.9655zm4.5954 0c-.3227.8611-1.2131 1.5132-2.2977 1.5132v1.5c1.6855 0 3.1516-1.0175 3.7023-2.4868zm-2.2977 1.5132c-1.0846 0-1.975-.6521-2.2977-1.5132l-1.4046.5264c.55065 1.4693 2.0168 2.4868 3.7023 2.4868z"></path>
                            </g>
                        </svg>
                    </Link>
                    ...
                    {dropdownOpen && (
                        <>
                            <div className={`absolute -right-[4rem] mt-2.5 flex h-[22.5rem] w-[18.75rem] flex-col rounded-sm border stroke-1 bg-white shadow sm:right-0 sm:w-[20rem]`}>
