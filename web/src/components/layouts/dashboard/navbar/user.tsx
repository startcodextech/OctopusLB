...
const DropdownUser: FC = () => {
    ...
    const handleDropdown = (value: boolean) => setDropdownOpen(value);

    return (
        <>
            <ClickOutside onClick={() => handleDropdown(false)} className="relative">
                <a href="#" className="flex items-center gap-4" onClick={() => handleDropdown(!dropdownOpen)}>
                    ...
                    <span className="h-12 w-12 rounded-full">
                      <Image src="/images/avatar.jpg" alt="User" className="h-12 w-12 rounded-full object-cover"
                             width={46} height={46}/>
                    </span>

                    <svg className="hidden fill-current sm:block" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            ...
                            <ul className="flex flex-col gap-5 border-b border-stroke">
                                <li className="px-6 py-3 text-gray-500 fill-gray-500 hover:text-primary hover:fill-primary duration-300 ease-in-out hover:bg-gray-100">
                                    <a
                                        ...
                                        <svg viewBox="-42 0 512 512.001" width={24} height={24} fill="none" className="fill-current">
                                            <path
