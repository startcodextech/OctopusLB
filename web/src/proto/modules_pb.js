...
proto.module.GetModulesResponse = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.module.GetModulesResponse.repeatedFields_,
    null
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.module.GetModulesResponse.displayName =
    'proto.module.GetModulesResponse';
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.module.GetModulesResponse.prototype.toObject = function (
    opt_includeInstance
  ) {
...
proto.module.GetModulesResponse.deserializeBinary = function (bytes) {
  ...
  return proto.module.GetModulesResponse.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.module.GetModulesResponse}
 */
proto.module.GetModulesResponse.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.module.Module.deserializeBinaryFromReader
        );
        msg.addResult(value);
        break;
      default:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.module.GetModulesResponse.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {!proto.module.Module}
 */
proto.module.GetModulesResponse.prototype.addResult = function (
  opt_value,
  opt_index
) {
